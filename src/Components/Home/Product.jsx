...
function Products() {
  ...
  const isLoggedIn = false; // Replace with your authentication logic (e.g., context or state)
  ...
  return (
    <section id="products" className="py-12 bg-zinc-100 flex flex-col gap-5 items-center">
      ...
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
        {displayedProducts.map((product) => (
          <div key={product.id} className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 flex flex-col justify-between">
            ...
            />
            <h3 className="text-xl font-bold text-center mb-6 mt-2">{product.name}</h3>
            <div className="flex justify-between mt-auto">
              <button
                className="px-4 py-2 bg-[#1B5C40] text-bold rounded-full text-white"
